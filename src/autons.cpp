...
void default_constants() {
  ...
  chassis.pid_swing_exit_condition_set(300_ms, 3_deg, 500_ms, 7_deg, 750_ms,
                                       750_ms);
  chassis.pid_drive_exit_condition_set(300_ms, 0.5_in, 500_ms, 1.5_in, 750_ms,
                                       750_ms);
...
void defensive_side_safe() {
  ...
  chassis.pid_turn_set(-56.312_deg,SAFE_TURN_SPEED);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(38.858_in, SAFE_DRIVE_SPEED);
  ...
  chassis.pid_drive_set(5.5_in, SAFE_DRIVE_SPEED);
  front_wings.set_value(true);
  chassis.pid_wait();
